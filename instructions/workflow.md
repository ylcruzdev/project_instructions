...
d. **Implementación**: 
    ...
    2. Crear los **tests unitarios** (`.test.js`) co-localizados
...
Una vez completadas **todas** las tareas, ejecutar los **tests E2E completos** de la HU.
La HU solo se considera **Done** cuando todos sus tests E2E pasan.
