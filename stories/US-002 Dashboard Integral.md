...
| **TK-002-01** | Implementación de peticiones a Open-Meteo para métricas de suelo y aire| Equipo Dev |
| **TK-002-02** | Desarrollo de la lógica de negocio para detectar umbrales de Mildiú y Botrytis | Equipo Dev |
| **TK-002-03** | Creación de componentes de alerta con directivas `v-show`/`v-if` | Equipo Dev |
| **TK-002-04** | Sistema de recomendaciones dinámicas basadas en el estado del cultivo | Equipo Dev |
